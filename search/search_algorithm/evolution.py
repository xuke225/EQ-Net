...
class EvolutionFinder:
    ...
    def random_valid_sample(self, constraint):
        ...
        while True:
            ...
            # if avg_w <= constraint_w and avg_a <= constraint_a:
            if constraint_w - 0.5 < avg_w <= constraint_w and constraint_a - 0.5 < avg_a <= constraint_a:
    ...
    def run_evolution_search(self, constraint, verbose=False, channel_wise=True, w_sym=True, a_sym=True, **kwargs):
        ...
        accs = self.accuracy_predictor.predict_acc(child_pool, channel_wise, w_sym, a_sym)
        ...
        with tqdm(total=self.max_time_budget,
                  desc='Searching with constraint_w (%s) constraint_a (%s)' % (constraint[0], constraint[1]),
